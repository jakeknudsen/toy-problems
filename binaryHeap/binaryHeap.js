...
BinaryHeap.prototype._getLesserChildIndex = function (parentIndex) {
  var childIndices = [parentIndex * 2 + 1, parentIndex * 2 + 2].filter(
    function (index) {
...
BinaryHeap.prototype.insert = function (node) {
  ...
  while (
    index > 0 &&
    this._compare(this._heap[index], this._heap[parentIndex])
  ) {
...
BinaryHeap.prototype.removeRoot = function () {
  ...
  while (
    lesserChildIndex &&
    this._compare(this._heap[lesserChildIndex], this._heap[temporaryRootIndex])
  ) {
